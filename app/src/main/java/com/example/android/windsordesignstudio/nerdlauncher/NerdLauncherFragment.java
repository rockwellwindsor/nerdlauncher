...
public class NerdLauncherFragment extends Fragment {
    ...
    private static final String TAG = "Nerd Launcher Fragment";
    ...
    private class ActivityHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent i = new Intent(Intent.ACTION_MAIN).setClassName(activityInfo.applicationInfo.packageName, activityInfo.name).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK); // Adding the flag means all activities will be started as their tasks
            startActivity(i);
        }
    }
